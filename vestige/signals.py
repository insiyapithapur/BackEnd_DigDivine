...
#     if created:
#         url = f"http://3.108.238.214:8081/api/activate?user_id={instance.user.id}&app_name=vestige&order_num={instance.orderNumber}"
#         payload={}
#         headers = {
...
@receiver(post_save, sender=VestigeUser)
...
@receiver(post_save, sender=VestigeUser)
def VestigeUserCreate(instance,created, **kwargs):
    if created:
        instance.vestige_user = True
        instance.save()