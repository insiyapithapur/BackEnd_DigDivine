...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('vestige', '0034_auto_20230819_1847'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='request_id',
            field=models.CharField(default='Q2D0ghZM', max_length=20),
        ),
        migrations.AlterField(
            model_name='presignup',
            name='signup_token',
            field=models.CharField(default='cXlt8ZrHlT', editable=False, max_length=255, unique=True),
        ),
    ]
