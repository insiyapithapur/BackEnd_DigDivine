...
class VestigeUser(models.Model):
...
class TagName(models.Model):
    ...
    tagImage = models.ImageField(upload_to="VestigeCategoryImages", null=True, blank=True)
...
class ProductImages(models.Model):
    ...
    image = models.ImageField(upload_to='VestigeProductImages', null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class DistributionPoint(models.Model):
    DPTYPE = (
            ('Vestige Super Store','Vestige Super Store'),
            ('Vestige Success Center (MSC)','Vestige Success Center (MSC)'),
            ('Vestige Lifestyle Center','Vestige Lifestyle Center'),
            ('Vestige Access Point (TFS Store)','Vestige Access Point (TFS Store)'),
    ...
    status = models.BooleanField(default=True)
    dp_branch_type = models.CharField(max_length=50, null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class Cart(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="VestigeUsercart",on_delete=models.CASCADE)
...
class UserShippingAddress(models.Model):
    user = models.ForeignKey(User, related_name="vestigeUser", on_delete=models.CASCADE)
...
class Order(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestigeOrderUser", on_delete=models.PROTECT)
    shippingDetails = models.ForeignKey(UserShippingAddress, related_name="vestigeUserShippingAddress", null=True, on_delete=models.PROTECT)
    orderNumber = models.CharField(max_length=30, unique=True, default=create_new_ref_number)
    status = models.BooleanField(default=True)
    distributionpoint = models.ForeignKey(DistributionPoint, related_name="vestigeDP", null=True, on_delete=models.PROTECT)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class OrderProduct(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    product = models.ForeignKey(Product, related_name="vestigeProduct", on_delete=models.PROTECT)
    productQty = models.PositiveIntegerField()
    PricePerPiece = models.CharField(max_length=30)
    DiscountPerPiece = models.CharField(max_length=30)
    order = models.ForeignKey(Order, null=True, related_name="vestigeOrderProducts", on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class ActivationCategory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    category = models.ForeignKey(TagName, related_name="vestige_product_count_category", on_delete=models.CASCADE)
...
class Activation(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestige_activation", on_delete=models.PROTECT)
...
class MoneyGenerateCategory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    category = models.ForeignKey(TagName, related_name="vestige_required_product_count_cat", on_delete=models.CASCADE)
    required_product = models.IntegerField(default=10)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class MoneyGenerate(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestige_money_gen", on_delete=models.PROTECT)
    day1_status = models.BooleanField(default=False)
    day1_status_completed = models.DateTimeField(null=True)
    day2_status = models.BooleanField(default=False)
    day2_status_completed = models.DateTimeField(null=True)
...
class UserAccount(models.Model):
    user = models.ForeignKey(User, related_name="vestige_user_account", on_delete=models.CASCADE)
    balance = models.DecimalField(max_digits=6, decimal_places=2)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class UserAccountHistory(models.Model):
    user = models.ForeignKey(User, related_name="vestige_user_account_history", on_delete=models.CASCADE)
    balance = models.DecimalField(max_digits=6, decimal_places=2)
...
class SectionData(models.Model):
    ...
    section_image = models.ImageField(upload_to='VestigeSectionImages', null=True, blank=True)
...
class OfferReferBgImage(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    view_all_offer = models.ImageField(upload_to='VestigeORDImage')
    dp_list = models.ImageField(upload_to='VestigeORDImage')
    refer_earn = models.ImageField(upload_to='VestigeORDImage')
...
class BrochureSections(models.Model):
    ...
    brochure_image = models.ImageField(upload_to="VestigeBrochureSections", null=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class Broucher(models.Model):
    ...
    book_pdf = models.FileField(upload_to='VestigeBookpdf', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class EarningModel(models.Model):
    ...
    description_link = models.FileField(upload_to='VestigeEarningModel', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class UserCoin(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="VestigeUser", on_delete=models.PROTECT)
...
class DailyCheckIn(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="VestigeDailyCheckIN", on_delete=models.PROTECT)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class CoinData(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="VestigeCoinData", on_delete=models.PROTECT)
...
class CoinSection(models.Model):
    ...
    image = models.ImageField(upload_to="VestigeCoinSection", null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class coinHistory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="VestigeCoinHistory", on_delete=models.PROTECT)
    coin = models.IntegerField()
...
class MCANumber(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.OneToOneField(User, related_name="vestige_mca_num", on_delete=models.CASCADE)
...
class UserBV(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.OneToOneField(User, related_name="vestige_user_bv",on_delete=models.CASCADE, null=True)
    mca_number = models.ForeignKey(MCANumber, related_name="vestige_user_bv_mca_num", on_delete=models.CASCADE)
...
class BVRequest(models.Model):
    ...
    mca_number = models.ForeignKey(MCANumber, related_name="vestige_bv_mca_num", on_delete=models.CASCADE)
...
class UserBVHistory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestige_user_bv_request", on_delete=models.CASCADE, null=True)
    mca_number = models.ForeignKey(MCANumber, related_name="vestige_bv_history_mca_num", on_delete=models.CASCADE)
...
class UserBVRequestHistory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestige_user_bv_request_history", on_delete=models.CASCADE, null=True)
...
class OrderTakenForBV(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestige_order_taken", blank=True, null=True, on_delete=models.CASCADE)
...
class LogData(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="vestige_log_data", on_delete=models.CASCADE, null=True)
...
class WatchVdoAds(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name='vestige_wva', on_delete=models.CASCADE, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class VestigeCreditTimer(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    post_click_wvdo_btn = models.DecimalField(max_digits=5,decimal_places=2)
    pre_click_wvdo_btn = models.DecimalField(max_digits=5,decimal_places=2)
    created_at = models.DateTimeField(auto_now_add=True)
...
class VestigeCreditAccess(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
