...
class ProteinWorldUserSerializer(serializers.ModelSerializer):
    # user = UserSerializer()
    class Meta:
        model = ProteinWorldUser
        fields = '__all__'
...
class OrderSerializer(serializers.ModelSerializer):
    orderProducts = OrderProductSerializer(many=True, source="ProteinWorldOrderProducts")
...
class proteinWorldCreditTimerSerializer(serializers.ModelSerializer):
    class Meta:
        model = DynamicTimer
        fields = '__all__'