...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('proteinWorld', '0017_auto_20230819_1855'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='request_id',
            field=models.CharField(default='5oErI5Dh', max_length=20),
        ),
        migrations.AlterField(
            model_name='presignup',
            name='signup_token',
            field=models.CharField(default='XfxlML4RlY', editable=False, max_length=255, unique=True),
        ),
    ]
