...
#     if created:
#         url = f"https://teamsbuilders.com/v1/api/check/{instance.user.id}/activation?appname=proteinWorld"
#         payload = ""
#         headers = {
...
@receiver(post_save, sender=ProteinWorldUser)
...
@receiver(post_save, sender=ProteinWorldUser)
def ProteinWorldUserCreate(instance,created, **kwargs):
    if created:
        instance.protein_world_user = True
        instance.save()