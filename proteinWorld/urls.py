...
from proteinWorld import views
...
router.register(r'app-user', views.ProteinWorldUserView)
...
router.register(r'credit-timer', views.proteinWorldCreditTimerView)

urlpatterns = [
    path('', include(router.urls)),
    path('user/<pk>/', csrf_exempt(views.ProteinWorldUserInfo.as_view())),
    ...
    path('view-offer', TemplateView.as_view(template_name="proteinWorld_view_all_offer.html")),
    path('how-to-collect-bv', TemplateView.as_view(template_name="proteinWorld_how_to_collect_bv.html")),
