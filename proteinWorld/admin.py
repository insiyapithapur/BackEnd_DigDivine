...
class OrderProduct(admin.ModelAdmin):
    ...
    search_fields = ('order__orderNumber',)
...
@admin.register(ProteinWorldUser)
class ProteinWorldUser(admin.ModelAdmin):
...
admin.site.register(proteinWorldCreditTimer)
admin.site.register(PWCreditAccess)
