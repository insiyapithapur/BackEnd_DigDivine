...
router.register(r'app-user', views.HHIUserView)
...
router.register(r'credit-timer', views.hhiCreditTimerView)

urlpatterns = [
    path('', include(router.urls)),
    path('user/<pk>/', csrf_exempt(views.HHIUserInfo.as_view())),
    ...
    path('<order_id>/generate/bill', views.BillsGeneration, name="billgeneration"),
    ...
    path('view-offer', TemplateView.as_view(template_name="hhi_view_all_offer.html")),
    path('how-to-collect-bv', TemplateView.as_view(template_name="hhi_how_to_collect_bv.html")),
