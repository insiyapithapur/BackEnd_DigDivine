# Generated by Django 3.2.9 on 2022-07-07 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='hhi_product_count_category', to='hhi.tagname')),
            ],
        ),
        migrations.CreateModel(
            name='Activation',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='hhi_activation', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
