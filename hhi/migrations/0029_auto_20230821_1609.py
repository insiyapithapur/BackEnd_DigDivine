...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='request_id',
            field=models.CharField(default='oLX7eqOi', max_length=20),
        ),
        migrations.AlterField(
            model_name='presignup',
            name='signup_token',
            field=models.CharField(default='PTV883FVF2', editable=False, max_length=255, unique=True),
        ),
    ]
