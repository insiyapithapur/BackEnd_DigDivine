...
class HHIUserSerializer(serializers.ModelSerializer):
    # user = UserSerializer()
    class Meta:
        model = HHIUser
        fields = '__all__'
...
class OrderSerializer(serializers.ModelSerializer):
    orderProducts = OrderProductSerializer(many=True, source="HHIOrderProducts")
...
class hhiCreditTimerSerializer(serializers.ModelSerializer):
    class Meta:
        model = DynamicTimer
        fields = '__all__'