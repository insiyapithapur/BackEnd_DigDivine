...
class AmulyaHerbalUser(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    AmulyaHerbal_user = models.BooleanField(default=False)
...
class TagName(models.Model):
    ...
    tagImage = models.ImageField(upload_to="AHCategoryImages", null=True, blank=True)
...
class ProductImages(models.Model):
    ...
    image = models.ImageField(upload_to='AHProductImages', null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class DistributionPoint(models.Model):
    DPTYPE = (
            ('AmulyaHerbal Super Store','AmulyaHerbal Super Store'),
            ('AmulyaHerbal Success Center (HSC)','AmulyaHerbal Success Center (HSC)'),
            ('AmulyaHerbal Lifestyle Center','AmulyaHerbal Lifestyle Center'),
            ('AmulyaHerbal Access Point (TFS Store)','AmulyaHerbal Access Point (TFS Store)'),
...
class Cart(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="AmulyaHerbalUsercart",on_delete=models.CASCADE)
...
class UserShippingAddress(models.Model):
    user = models.ForeignKey(User, related_name="AmulyaHerbalUser", on_delete=models.CASCADE)
...
class Order(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="AmulyaHerbalOrderUser", on_delete=models.PROTECT)
    shippingDetails = models.ForeignKey(UserShippingAddress, related_name="AmulyaHerbalUserShippingAddress", null=True, on_delete=models.PROTECT)
    orderNumber = models.CharField(max_length=30, unique=True, default=create_new_ref_number)
    status = models.BooleanField(default=True)
    distributionpoint = models.ForeignKey(DistributionPoint, related_name="AmulyaHerbalDP", null=True, on_delete=models.PROTECT)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class OrderProduct(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    product = models.ForeignKey(Product, related_name="AmulyaHerbalProduct", on_delete=models.PROTECT)
    productQty = models.PositiveIntegerField()
    PricePerPiece = models.CharField(max_length=30)
    DiscountPerPiece = models.CharField(max_length=30)
    order = models.ForeignKey(Order, null=True, related_name="AmulyaHerbalOrderProducts", on_delete=models.CASCADE)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class ActivationCategory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    category = models.ForeignKey(TagName, related_name="amulyaHerb_product_count_category", on_delete=models.CASCADE)
...
class Activation(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerb_activation", on_delete=models.PROTECT)
...
class MoneyGenerateCategory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    category = models.ForeignKey(TagName, related_name="amulyaHerb_required_product_count_cat", on_delete=models.CASCADE)
    required_product = models.IntegerField(default=10)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class MoneyGenerate(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerb_money_gen", on_delete=models.PROTECT)
    day1_status = models.BooleanField(default=False)
    day1_status_completed = models.DateTimeField(null=True)
    day2_status = models.BooleanField(default=False)
    day2_status_completed = models.DateTimeField(null=True)
...
class UserAccount(models.Model):
    user = models.ForeignKey(User, related_name="amulyaHerb_user_account", on_delete=models.CASCADE)
    balance = models.DecimalField(max_digits=6, decimal_places=2)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class UserAccountHistory(models.Model):
    user = models.ForeignKey(User, related_name="amulyaHerb_user_account_history", on_delete=models.CASCADE)
    balance = models.DecimalField(max_digits=6, decimal_places=2)
...
SECTIONTITLE = (
        ...
        ('About Amulya Herbal','About Amulya Herbal'),
...
class SectionData(models.Model):
    ...
    section_image = models.ImageField(upload_to='AHSectionImages', null=True, blank=True)
...
class OfferReferBgImage(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    view_all_offer = models.ImageField(upload_to='AHORDImage')
    dp_list = models.ImageField(upload_to='AHORDImage')
    refer_earn = models.ImageField(upload_to='AHORDImage')
...
class BrochureSections(models.Model):
    ...
    brochure_image = models.ImageField(upload_to="AHBrochureSections", null=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class Broucher(models.Model):
    ...
    book_pdf = models.FileField(upload_to='AHBookpdf', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True, null=True)
...
class EarningModel(models.Model):
    ...
    description_link = models.FileField(upload_to='AHEarningModel', blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class UserCoin(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="AmulyaHerbalUserCoin", on_delete=models.PROTECT)
...
class DailyCheckIn(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="AmulyaHerbalDailyCheckIN", on_delete=models.PROTECT)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class CoinData(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="AmulyaHerbalCoinData", on_delete=models.PROTECT)
...
class CoinSection(models.Model):
    ...
    image = models.ImageField(upload_to="AHCoinSection", null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class coinHistory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="AmulyaHerbalCoinHistory", on_delete=models.PROTECT)
    coin = models.IntegerField()
...
class MCANumber(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.OneToOneField(User, related_name="amulyaHerbal_mca_num", on_delete=models.CASCADE)
...
class UserBV(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.OneToOneField(User, related_name="amulyaHerbal_user_bv",on_delete=models.CASCADE, null=True)
    mca_number = models.ForeignKey(MCANumber, related_name="amulyaHerbal_user_bv_mca_num", on_delete=models.CASCADE)
...
class BVRequest(models.Model):
    ...
    mca_number = models.ForeignKey(MCANumber, related_name="amulyaHerbal_bv_mca_num", on_delete=models.CASCADE)
...
class UserBVHistory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerbal_user_bv_request", on_delete=models.CASCADE, null=True)
    mca_number = models.ForeignKey(MCANumber, related_name="amulyaHerbal_bv_history_mca_num", on_delete=models.CASCADE)
...
class UserBVRequestHistory(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerbal_user_bv_request_history", on_delete=models.CASCADE, null=True)
...
class OrderTakenForBV(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerbal_order_taken", blank=True, null=True, on_delete=models.CASCADE)
...
class LogData(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerbal_log_data", on_delete=models.CASCADE, null=True)
...
class WatchVdoAds(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    user = models.ForeignKey(User, related_name="amulyaHerbal_wva", on_delete=models.CASCADE, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

class CreditAccess(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
...
class AmulHerbalCreditTimer(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True)
    post_click_wvdo_btn = models.DecimalField(max_digits=5,decimal_places=2)
    pre_click_wvdo_btn = models.DecimalField(max_digits=5,decimal_places=2)
    created_at = models.DateTimeField(auto_now_add=True)
