...
from amulyaHerbal import views
...
# router.register(r'user', views.AmulyaHerbalUserInfo, basename='user')
router.register(r'app-user', views.AmulyaHerbalUserView)
...
router.register(r'credit-timer', views.AmulHerbalCreditTimerView)

urlpatterns = [
    path('', include(router.urls)),
    path('user/<pk>/', csrf_exempt(views.AmulyaHerbalUserInfo.as_view())),
    ...
    path('view-offer', TemplateView.as_view(template_name="amulyaHerbal_view_all_offer.html")),
    path('how-to-collect-bv', TemplateView.as_view(template_name="amulyaHerbal_how_to_collect_bv.html")),
