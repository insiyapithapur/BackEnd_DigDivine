# Generated by Django 3.2.9 on 2022-06-04 06:41

import amulyaHerbal.models
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dp_type', models.CharField(choices=[('AmulyaHerbal Super Store', 'AmulyaHerbal Super Store'), ('AmulyaHerbal Success Center (HSC)', 'AmulyaHerbal Success Center (HSC)'), ('AmulyaHerbal Lifestyle Center', 'AmulyaHerbal Lifestyle Center'), ('AmulyaHerbal Access Point (TFS Store)', 'AmulyaHerbal Access Point (TFS Store)'), ('DISTRIBUTION POINTS (DPS)', 'DISTRIBUTION POINTS (DPS)')], default='DISTRIBUTION POINTS (DPS)', max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('orderNumber', models.CharField(default=amulyaHerbal.models.create_new_ref_number, max_length=30, unique=True)),
                ('status', models.BooleanField(default=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('distributionpoint', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalDP', to='amulyaHerbal.distributionpoint')),
            ],
            options={
                'ordering': ('-created_at',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('brand', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='amulyaHerbal.brand')),
            ],
            options={
                'ordering': ('-created_at',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_name', models.CharField(choices=[('Why AmulyaHerbal', 'Why AmulyaHerbal'), ('Learnings', 'Learnings'), ('Archivers', 'Archivers'), ('Events', 'Events')], default=None, max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AmulyaHerbalUser', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='UserCoin',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalUserCoin', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='TagHirarchy',
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='category', to='amulyaHerbal.tagname')),
                ('subcategory', models.ManyToManyField(related_name='subcategory', to='amulyaHerbal.TagName')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='productImages', to='amulyaHerbal.product')),
            ],
        ),
        migrations.CreateModel(
            name='OrderProduct',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('order', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='AmulyaHerbalOrderProducts', to='amulyaHerbal.order')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalProduct', to='amulyaHerbal.product')),
            ],
        ),
        migrations.AddField(
            model_name='order',
            name='shippingDetails',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalUserShippingAddress', to='amulyaHerbal.usershippingaddress'),
        ),
        migrations.AddField(
            model_name='order',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalOrderUser', to=settings.AUTH_USER_MODEL),
        ),
        migrations.CreateModel(
            name='DailyCheckIn',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalDailyCheckIN', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='coinHistory',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalCoinHistory', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='CoinData',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='AmulyaHerbalCoinData', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Broucher',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('brochure', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='amulyaHerbal.brochuresections')),
            ],
        ),
        migrations.CreateModel(
            name='AmulyaHerbalUser',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, unique=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='p_category', to='amulyaHerbal.tagname')),
                ('product', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='amulyaHerbal.product')),
                ('subcategory', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='P_subcategory', to='amulyaHerbal.tagname')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productQty', models.PositiveIntegerField()),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='amulyaHerbal.product')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='AmulyaHerbalUsercart', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('-created_at',),
