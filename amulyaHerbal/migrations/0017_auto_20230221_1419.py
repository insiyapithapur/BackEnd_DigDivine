...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('amulyaHerbal', '0016_auto_20230130_2017'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='request_id',
            field=models.CharField(default='dY8cSO2g', max_length=20),
        ),
        migrations.AlterField(
            model_name='presignup',
            name='signup_token',
            field=models.CharField(default='TQIrOGAetz', editable=False, max_length=255, unique=True),
        ),
    ]
