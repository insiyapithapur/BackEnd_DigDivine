...
#     if created:
#         url = f"https://teamsbuilders.com/v1/api/check/{instance.user.id}/activation?appname=amulyaHerbal"
#         payload = ""
#         headers = {
...
@receiver(post_save, sender=AmulyaHerbalUser)
...
@receiver(post_save, sender=AmulyaHerbalUser)
def amulyaHerbalUserCreate(instance,created, **kwargs):
    if created:
        instance.AmulyaHerbal_user = True
        instance.save()