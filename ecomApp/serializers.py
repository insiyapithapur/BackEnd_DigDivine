...
class UserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id','userId','mob','first_name','last_name','email','is_active','address','profile_picture','user_mob_id')

class ModicareUserSerializer(serializers.ModelSerializer):
    # user = UserSerializer()
    class Meta:
        model = ModicareUser
        fields = '__all__'
...
class BillFormatSerializer(serializers.ModelSerializer):
    class Meta:
        model = BillFormat
        fields = '__all__'
